...
const AdminAuth = () => {
  ...
  if (isLoadingCheck) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-secondary via-background to-secondary text-foreground">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-secondary via-background to-secondary flex items-center justify-center p-4">
      ...
      <Card className="w-full max-w-md p-8 bg-card border-border shadow-2xl relative z-10 space-y-6">
        <div className="text-center space-y-2">
          <Link to="/" className="inline-flex items-center justify-center space-x-2 group">
            ...
            <span className="text-2xl font-bold text-foreground tracking-tight">MedConnect</span>
          </Link>
        ...
        {hasAdmin ? (
          ...
          <form onSubmit={handleSignUpSubmit} className="space-y-4">
            ...
            <p className="text-[11px] text-amber-500 dark:text-amber-400 text-center leading-relaxed font-medium">
